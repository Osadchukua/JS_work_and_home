...
// let user = { gh: 'rger', fg: '[ghzd, srth, rth]' };

// let permissions1 = { canyeryView: true };
// let permissions2 = { canEetydit: true };

// // копіює всі властивості з permissions1 та permissions2 у user
// Object.assign(user, permissions1, permissions2, { name: 'Петро' });
...
// console.log(user.sizes.height + user.sizes.width);
